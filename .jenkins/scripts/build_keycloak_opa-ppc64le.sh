...
docker load < $HOME/$PPC64LE_IMAGE_TARBALL_DIR/keycloak-15.0.2.tar
docker load < $HOME/$PPC64LE_IMAGE_TARBALL_DIR/keycloak-init-container-master.tar
docker load < $HOME/$PPC64LE_IMAGE_TARBALL_DIR/keycloak-operator-15.0.2.tar
docker load < $HOME/$PPC64LE_IMAGE_TARBALL_DIR/opa-latest.tar
